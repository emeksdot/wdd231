...
async function getProphetData() {
  ...
  console.log(typeof data.prophets); // test if an object or array
  displayProphets(data.prophets); // confirmation that it is an array
